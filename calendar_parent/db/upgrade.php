...
function xmldb_block_calendar_month_upgrade($oldversion, $block) {
    ...
    if ($oldversion < 2022030200) {
        ...
        upgrade_block_set_defaultregion('calendar_parent', '__default', 'my-index', 'content');
        upgrade_block_savepoint(true, 2022030200, 'calendar_parent', false);
    }

    if ($oldversion < 2022041901) {
        upgrade_block_set_my_user_parent_context('calendar_parent', '__default', 'my-index');
        upgrade_block_savepoint(true, 2022041901, 'calendar_parent', false);
    }
